...
export default function HardDriveReportView({hardDrive,children, smartAttributes}:any){
    let formatted: any = processHardDriveData(hardDrive)
    return (hardDrive && <Container>
        <Form className={"pt-5"}>
            ...
            {hardDrive.smartAttributes?.length > 0 && smartAttributes }
            {children}
        </Form>
    </Container>)
}