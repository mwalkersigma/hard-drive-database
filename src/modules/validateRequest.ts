...
export default function validateRequest(req:NextApiRequest,wasFileAlreadyParsed:boolean):{valid:boolean,message:string}{
    ...
    if(wasFileAlreadyParsed)return badRequest("This file has already been added to DB")
